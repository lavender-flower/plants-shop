    ...
    return (
      ...
      <Carousel.Item>
        ...
        <Carousel.Caption className='text-light caveat text-start po' style={{marginBottom:'10vw',marginRight:'40vw'}}>
          <h5 style={{fontSize:'4vw'}} >The Benefits of Plants</h5>
      ...
      <Carousel.Item>
        ...
        />
        <Carousel.Caption className='text-light  caveat text-start po' style={{marginBottom:'10vw',marginRight:'40vw'}}>
          <h5  style={{fontSize:'4vw'}} >Quality Plant Care and Accessories</h5>
          <p>A little green companion to brighten my day.
          Leaf me alone with my indoor plants.</p>
      ...
      <Carousel.Item>
        ...
        />
        <Carousel.Caption className='text-light  caveat text-start po' style={{marginBottom:'10vw',marginRight:'40vw'}}>
          <h5  style={{fontSize:'4vw'}} >For The True <br></br>Plants Lover</h5>
          <p>
  ...
  <div className="row po text-center">
    ...
    <div className='img-hover-zoom' style={{borderRadius:'1.3vw'}}><img src='images/banner14.jpg' width='400vw' ></img></div>
        ...
        <section className='px-5 po'>
          <div><h1 className='caveat text-success po' style={{fontSize:'4vw'}} >
...
<Link  className='text-decoration-none text-success caveat' style={{fontSize:'2vw'}} to='/planters'>View All  <FontAwesomeIcon className='ps-2 ' style={{fontSize:'1vw'}} icon={faArrowRight} /></Link>
        </section>
        

        <section className=' px-5 pb-5 pt-5 po'>
       <div className=' row bg-light text-center '> 
          <div style={{marginTop:'6.5vw'}} className='col-lg p-5' ><h1 className='caveat ' style={{fontSize:'4vw'}}>The Benefits<br></br> 
          ...
          <div className='col-lg   p-5' style={{marginTop:'6.5vw'}}><p className='caveat '>“Phasellus tempus dignissim nisl, eu <br></br> interdum felis interdum consequat. Vestibulum varius dui vel tincidunt convallis.”</p>
          <Link  className='text-decoration-none text-success caveat' style={{fontSize:'2vw'}} to='/shopplants'>shop now  <FontAwesomeIcon className='ps-2 ' style={{fontSize:'1vw'}} icon={faArrowRight} /></Link>
        ...
        <section className='px-5 row po'>
          ...
          <div><h1 className='caveat text-start ps-3 text-success po' style={{fontSize:'4vw'}} >
        ...
        <div className="row row-cols-1 row-cols-md-2 g-4 px-3 po">
  {
    plant.slice(0,4).map(doc=>{
      ...
      <div className="overlay-c d-flex justify-content-between p-2">
        <div className='text-start'>
            <p style={{fontSize:'2vw'}}>{doc.name}</p>
            <p>{doc.category}</p>
        </div>
        <div className='text-end'>
            <p style={{fontSize:'2vw'}}>{doc.price} tk</p>
            <p>{doc.size} pot</p>
        </div>
      </div>
    </div>
        ...
        <Link  className='text-decoration-none text-center text-success caveat' style={{fontSize:'1.8vw'}} to='/shopplants'>View All  <FontAwesomeIcon className='ps-2 ' style={{fontSize:'1vw'}} icon={faArrowRight} /></Link>
  ...
  <div className="row caveat text-success text-start">
    ...
    <p style={{fontSize:'2vw'}}>Smart Plant & Tree Care</p>
    <p style={{fontSize:'1.5vw'}}>We want to help keep your plants ever-green.</p>
    </div>
    <div className="col-lg">
    ...
    <p style={{fontSize:'2vw'}}>Nursery Direct</p>
    <p style={{fontSize:'1.5vw'}}>We want to help keep your plants ever-green.</p>
    </div>
    <div className="col-lg">
    ...
    <p style={{fontSize:'2vw'}}>Plant Sentry</p>
    <p style={{fontSize:'1.5vw'}}>We want to help keep your plants ever-green.</p>
    </div>
    <div className="col-lg">
    <div style={{backgroundColor: 'rgba(0, 0, 0, 0.04)',width:'10vw',borderRadius:'95px 0px 100px 0px'}} ><img className='child bounce'   src="images/4.png"></img></div>
        <p style={{fontSize:'2vw'}}>Plant Renovation</p>
    <p style={{fontSize:'1.5vw'}}>We want to help keep your plants ever-green.</p>
    </div>
        ...
        <section className='px-5 text-start row po'>
         <div className='col'> <div><h1 className='caveat text-success ps-3' style={{fontSize:'4vw'}} >
...
<img className='' style={{borderRadius:'2vw'}}  height='750vw'  src="images/b.webp"></img>
        ...
        <Link  className='text-decoration-none text-center text-success caveat' style={{fontSize:'1.8vw'}} to='/plantcare'>View All  <FontAwesomeIcon className='ps-2 ' style={{fontSize:'1vw'}} icon={faArrowRight} /></Link> 
        <section className='bg-light py-5 my-5 po' >
          <div className='row caveat px-5'>
            <div className='col text-start' >
              <h1 style={{fontSize:'2vw'}}> Subscribe Us</h1>
              <h1 style={{fontSize:'4vw'}}>Sign Up To Our<br></br> Newsletter</h1>
